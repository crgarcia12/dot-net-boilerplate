...
{
    public abstract class ContosoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ContosoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ContosoWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ContosoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ContosoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ContosoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ContosoDbContext, Task<T>> func)
        {
            T result;
